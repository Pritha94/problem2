...
function ShowData() {
    ...
    return (
        <>
            ...
            <>
                <div className="use-inline date header-color" style={{ width: 200 }}>Date</div>
                <div className="use-inline date header-color">Product purchesed</div>
                <div className="use-inline date header-color" style={{ width: 112 }}>Price</div>
                <div className="use-inline date header-color" style={{ width: 112 }}>Payee</div>
            </>
            {
                items && (
                    items.map(
                        (user, idx) => (
                            <div key={idx}>
                                ...
                                <div className={`use-inline date ${user.payeeName}`}>{user.payeeName}</div>
                            </div>
                        )
                    )
                )
